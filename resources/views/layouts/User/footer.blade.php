                ...
                <div class="row">
                        ...
                        <div class="block text">
                            <div class="block-content">
                                <a href="index.html" class="logo-footer">
                                    <img style="height:65px; width:136px;" src="{{('img/logoa.jpg')}}" alt="Logo">
                                </a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="block newsletter">
                            ...
                            <div class="block-content">
                                <p class="description">Sign up for newsletter to receive special offers and
                                    exclusive news about FreshMart products</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                    <div class="copyright"><a target="_blank" href="https://www.templateshub.net">Templates
                            Hub</a></div>
                </div>
